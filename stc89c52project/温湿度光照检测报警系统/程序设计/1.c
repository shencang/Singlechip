...
uint8 code str5[]="%RH";
uint8 code str6[]="TempHigh:";	  //设定温度上限显示
uint8 code str7[]="TempLow:";	  //设定温度下限显示
uint8 code str8[]="HumiHigh:";	   //设定湿度上限显示
uint8 code str9[]="HumiLow:";	   //设定湿度下限显示

//温度传感器相关
uint8 code str_light[]="light:";
uint8 code str10[]="LightHigh:";	   //设定湿度上限显示
uint8 code str11[]="LightLow:";	   //设定湿度下限显示
...
void datapros()
{
	...
	i++;
	disp[0]=num[temp/1000];//千位
	disp[1]=num[temp%1000/100];//百位
	disp[2]=num[temp%1000%100/10];//个位
	disp[3]=num[temp%1000%100%10];		
}
...
void data_pros()	//数据处理函数
{
	...
	//光照添加的内容
	temps = Read_AD_Data(0xA4);		//   AIN2 光敏电阻
	disp[0]=num[temps/1000];//千位
	disp[1]=num[temps%1000/100];//百位
	disp[2]=num[temps%1000%100/10];//个位
	disp[3]=num[temps%1000%100%10];		
